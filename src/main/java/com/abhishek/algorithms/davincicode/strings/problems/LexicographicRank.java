...
public class LexicographicRank {
  ...
  private int getLexicographicRank(String txt) {
  ...
  private LinkedHashSet<String> permuteString(String s, int l, int r,
  ...
  private String swap(String str, int newIndex, int oldIndex) {
