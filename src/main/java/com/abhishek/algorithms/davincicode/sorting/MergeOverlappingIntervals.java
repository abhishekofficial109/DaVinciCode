 ...
 * 
 * Logic:
 * 1. Sort the list in the increasing order of its begin time
 * 2. Iterate and check
 * 
 * @author abhishek
 *
...
public class MergeOverlappingIntervals {
	...
	public static ArrayList<Pair<Integer, Integer>> mergeOverlappingIntervals(List<Pair<Integer, Integer>> list,
			int n) {
